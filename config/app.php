...
return [
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'timeout' => 30,
            /*
             * It is recommended to set these optiosupport@wlsphoenix.dens through your environment or app_local.php
             */
            'username' 		=> 'support@wlsphoenix.de',
            'password' 		=> '7mD3evwc-qwz',
    ...
    'Email' => [
        'default' => [
            'transport' 	=> 'default',
            'from'          => ['support@wlsphoenix.de' => 'WLS Phoenix'],
        ],
    ],
